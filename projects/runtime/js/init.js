var init = function (window) {
    ...
    var background = opspark.makeBackground(app, ground); // calls background function and stores in in var background
    ...
    var hud = opspark.makeHud(); // calls makeHud function and stores it in var hud
    view.addChild(hud); // uses addChild to add hud to the child of view to make it visible on screen
    window.hud = hud; // assignes hud to window.hud
